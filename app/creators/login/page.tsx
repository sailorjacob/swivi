...
export default function CreatorsLoginPage() {
  ...
  useEffect(() => {
    ...
    if (session) {
      ...
      router.push("/creators/dashboard/campaigns")
    }
          ...
          <Card className="bg-neutral-900 border border-neutral-700 backdrop-blur-sm shadow-2xl">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed max-w-sm mx-auto">
                Sign in to access your creator dashboard and continue earning
              </p>
            </CardHeader>
            ...
            <CardContent className="space-y-4 px-8 pb-8">
              ...
              <div className="text-center mt-6 pt-4 border-t border-neutral-700/50">
                <p className="text-sm text-neutral-400 mb-2">
                  ...
                  <Link href="/creators/signup" className="text-white hover:text-green-300 underline underline-offset-2 transition-colors">
                    Sign up
                  </Link>
                </p>
                <p className="text-xs text-neutral-500 leading-relaxed">
                  By continuing, you agree to our{" "}
                  <Link href="/creators/rules" className="text-neutral-300 hover:text-white underline underline-offset-2 transition-colors">
