...
interface NavItem {
  ...
  const getNavItems = (isAdmin: boolean): NavItem[] => [
    { label: "Campaigns", href: "/creators/dashboard/campaigns", icon: "https://xaxleljcctobmnwiwxvx.supabase.co/storage/v1/object/public/images/345.png" },
    { label: "Dashboard", href: "/creators/dashboard", icon: "https://xaxleljcctobmnwiwxvx.supabase.co/storage/v1/object/public/images/3422.png" },
    { label: "Profile", href: "/creators/dashboard/profile", icon: "https://xaxleljcctobmnwiwxvx.supabase.co/storage/v1/object/public/images/342.png" },
    // Analytics temporarily hidden for platform cleanup
    // { label: "Analytics", href: "/creators/dashboard/analytics", icon: BarChart3 },
    { label: "Payouts", href: "/creators/dashboard/payouts", icon: "https://xaxleljcctobmnwiwxvx.supabase.co/storage/v1/object/public/images/233.png" },
...
function Sidebar({ className }: { className?: string }) {
  ...
  const isActive = (href: string) => {
    if (href === "/creators/dashboard") {
      return pathname === "/creators/dashboard"
    }
    ...
    <div className={cn("flex flex-col h-full bg-card border-r border-border", className)}>
      ...
      <div className="p-6 border-b border-border">
        <Link href="/" className="flex items-center space-x-4 hover:opacity-80 transition-opacity">
          <SwiviLogo size={36} />
          <div>
            <h1 className="text-foreground font-light text-lg">Swivi Creators</h1>
            {isDemoMode && (
      ...
      <div className="flex-1 flex flex-col h-full">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 border-b border-border flex-shrink-0">
          <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
            <SwiviLogo size={32} />
            <h1 className="text-foreground font-light">Swivi Creators</h1>
          </Link>
