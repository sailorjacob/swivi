...
export default function AnalyticsPage() {
  ...
  const stats = [
    ...
    { label: "Successful Posts", value: "47", change: "+8 this month", icon: TrendingUp },
            ...
            {topCampaigns.map((campaign, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{campaign.clips} posts submitted</p>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                { action: "Post approved", campaign: "Olivia Dean", time: "5 hours ago" },
