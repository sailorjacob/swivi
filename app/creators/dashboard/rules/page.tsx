...
const rulesSections = [
  {
    ...
    rules: [
      ...
      },
      {
        ...
        description: "All posts must be high-quality, engaging, and follow the campaign guidelines. Low-quality or spam content will be rejected."
      },
      {
    ...
    rules: [
      {
        ...
        description: "All posts must be at least 7 seconds long. Shorter posts will be automatically rejected."
      },
      {
        title: "Engagement Rate",
        description: "Posts must maintain a minimum 0.5% engagement rate (likes + comments + shares ÷ views × 100)."
      },
      {
    ...
    rules: [
      {
        ...
        description: "No creator can earn more than 30% of the total campaign budget to ensure fair distribution."
      },
      {
    ...
    rules: [
      {
        ...
        description: "Posts must be in the correct format for each platform (TikTok, YouTube Shorts, Instagram Reels, etc.)."
      },
      {
        title: "Metadata Accuracy",
        description: "All post submissions must include accurate metadata and follow the submission guidelines."
      },
      {
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Important rules and policies for all Swivi Creators. Please read carefully and follow all guidelines.
        </p>
      </div>
      ...
      <Card className="bg-card border-border">
        <CardContent className="p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-xl font-medium text-foreground">Welcome to Swivi Creators</h2>
          </div>
          <p className="text-muted-foreground leading-relaxed">
            These rules ensure fair play, quality content, and a positive community for all creators.
