          ...
          <Card className="bg-neutral-900 border border-neutral-700 backdrop-blur-sm shadow-2xl">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-neutral-400 text-sm">
                Connect your account to start earning from viral posts
              </p>
            </CardHeader>
            ...
            <CardContent className="space-y-4 px-8 pb-8">
              ...
              <div className="text-center pt-4 border-t border-neutral-700/50">
                <p className="text-sm text-neutral-400">
                  ...
                  <Link href="/creators/login" className="text-white hover:text-green-300 underline underline-offset-2 transition-colors">
                    Sign in
                  </Link>
                </p>
              </div>
