...
export default function SupportPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
          ...
          <GuideSection title="How to Verify Your Social Accounts" defaultOpen={true}>
            <div className="space-y-5 pt-4">
              <p className="text-sm text-muted-foreground">
                Verifying your social accounts proves you own them and allows us to track your clips.
              </p>
            ...
            <div className="space-y-5 pt-4">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Clips need at least 0.5% engagement rate to qualify.
                  </p>
                </div>
                
                <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                  <h4 className="font-medium text-sm text-foreground mb-1">Max 30% Per Clipper</h4>
                  <p className="text-xs text-muted-foreground">
                    Each clipper can earn up to 30% of total campaign budget.
                  </p>
                </div>
              </div>

              <NoteBox type="info">
                Submit clips as soon as you post them to maximize view accumulation time.
              </NoteBox>
            </div>
          </GuideSection>
            ...
            <div className="space-y-5 pt-4">
              <div className="space-y-0">
                <Step number={1} title="Campaign Active">
                  Submit clips and watch your views grow. Stats update every 2 hours.
                </Step>
                ...
                <Step number={3} title="Review Period">
                  We review clips and finalize earnings. Takes 1-3 days after campaign ends.
                </Step>
            ...
            <div className="space-y-3 pt-4">
              <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                ...
                <ul className="text-xs text-muted-foreground list-disc list-inside space-y-0.5">
                  ...
                  <li>Clips submitted after campaign ended</li>
                  <li>Clips didn't meet campaign requirements</li>
                </ul>
              </div>
      ...
      <div id="submissions">
        <h2 className="text-lg font-medium text-foreground mb-3">Submitting Clips</h2>
        
        <div className="space-y-3">
          <GuideSection title="How to Submit Your Clips">
            <div className="space-y-5 pt-4">
              <div className="space-y-0">
                <Step number={1} title="Post Your Clip">
                  Create and post your clip on TikTok, YouTube Shorts, or Instagram Reels.
                </Step>
                ...
                <Step number={3} title="Submit Your Clip">
                  <ul className="list-disc list-inside space-y-1 text-xs">
                    <li><strong>Scan Account:</strong> Automatically fetches recent clips</li>
          ...
          <GuideSection title="Clip Requirements">
            <div className="space-y-3 pt-4">
              <div className="grid md:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
              ...
              <NoteBox type="warning">
                Keep clips public. Private or deleted videos won't receive payment.
              </NoteBox>
            </div>
          </GuideSection>
        </div>
