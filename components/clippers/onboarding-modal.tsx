...
const initialSteps: OnboardingStep[] = [
  {
    ...
    content: (
      <div className="text-center space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-light text-white mb-4">Welcome to Swivi Clippers!</h2>
    ...
    content: (
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed">
            Great job! You've successfully set up your Swivi Clippers account.
...
export function OnboardingModal({ isOpen, onClose }: OnboardingModalProps) {
  ...
  const handleNext = () => {
    if (currentStep < steps.length - 1) {
      ...
      setSteps(newSteps)
      setIsCompleted(true)
      toast.success("Welcome to Swivi Clippers! 🎉")
      setTimeout(() => {
        onClose()
      }, 2000)
    }
